...
IMAGENET_PATH = "/disk_c/han/data/imagenetC/" # TODO specify ImageNet path
STYLIZED_IMAGENET_PATH = "/disk_c/han/data/imagenetC-stylized/" # TODO specify target path: where should Stylized-ImageNet be stored?
